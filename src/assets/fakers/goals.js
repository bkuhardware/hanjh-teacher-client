export default {
    ...
    requirements: [
        {
            _id: 1,
            content: 'You will need a computer and an interest in learning Django!',
            owner: {
                //last owner
                _id: 1,
                name: 'Thuy Huyen',
        ...
        {
            _id: 2,
            content: 'Some experience with coding in any language is a plus, but not required',
            owner: {
                //last owner
                _id: 1,
                name: 'Thuy Huyen',
        ...
        {
            _id: 3,
            content: 'ES6 Knowledge is advantageous',
            owner: {
                //last owner
                _id: 1,
                name: 'Thuy Huyen',
        ...
        {
            _id: 4,
            content: 'An appreciation of AJAX is a plus but not essential',
            owner: {
                //last owner
                _id: 2,
                name: 'Trong Luan',
